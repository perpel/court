...
class m151218_075121_identify extends Migration
{
    

    const TBL_NAME = '{{%identify}}';
    public function safeUp()
    {
        ...
        $this->createTable(self::TBL_NAME, [
            ...
            'IdentifiedType' => Schema::TYPE_STRING . "(50) COMMENT '鉴定类型'",
            ...
            'SuggestionAdmissible' => Schema::TYPE_STRING . "(12) COMMENT '鉴定意见是否采信'",
            'IdentifiedResult' => Schema::TYPE_TEXT . " COMMENT '鉴定结论'",
